define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'recharge/exchange/index' + location.search,
                    add_url: 'recharge/exchange/add',
                    edit_url: 'recharge/exchange/edit',
                    del_url: 'recharge/exchange/del',
                    multi_url: 'recharge/exchange/multi',
                    table: 'exchange',
                }
            });
